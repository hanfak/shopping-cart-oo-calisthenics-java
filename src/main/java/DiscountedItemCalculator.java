...
public class DiscountedItemCalculator {
  ...
  private BigDecimal calulateTotalOfDiscountedItemsA(BigDecimal totalDiscountedItems, ScannedItems scannedItems) {
  ...
  private BigDecimal calulateTotalOfDiscountedItemsB(BigDecimal totalDiscountedItems, ScannedItems scannedItems) {
